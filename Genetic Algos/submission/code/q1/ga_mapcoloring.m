...
load usmap; 
params = struct(...
    'psize',500,...%m %change to 10,1000
    'offspringsize',498,...%l %change to 8,1000-2
    'n',50,...%N
    'maxiter',500,...%mtimer
    'tournament',5,...%k %chnage K if needed
    'mutationrate',0.1,...%pm
...
s=a(:,id);
s(:,501:end)=[];%change according to number of parent,child
p=s;
sc1(:,501:end)=[];%change according to number of parent,child
sc=sc1;
end
